...
// ============================================================
// Dato sensible de ejemplo: PIN de acceso a la caja de concesiones.
// En una app real este sería el PIN real que el cajero ingresa al
// abrir turno — nunca se guarda en AsyncStorage ni en MMKV sin cifrar.
// ============================================================
const SENSITIVE_KEY = 'concessions_register_pin';
const MOCK_SENSITIVE = 'PIN-4821';
...
export function SettingsScreen(): React.JSX.Element {
  ...
  async function handleSaveSensitive(): Promise<void> {
    ...
    setIsSaved(true);
    Alert.alert('Guardado', 'El PIN de caja se guardó de forma cifrada.');
  }
  ...
  async function handleReadSensitive(): Promise<void> {
    ...
    if (value) {
      ...
      Alert.alert('No encontrado', 'No hay PIN de caja guardado aún.');
    }
  }
  ...
  async function handleDeleteSensitive(): Promise<void> {
    ...
    setIsSaved(false);
    setMaskedValue(null);
    Alert.alert('Eliminado', 'El PIN de caja fue removido de SecureStore.');
  }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.rowDesc}>
        PIN de caja de concesiones: <Text style={styles.mono}>{SENSITIVE_KEY}</Text>
        {isSaved ? ' (guardado)' : ' (no guardado)'}
      </Text>
